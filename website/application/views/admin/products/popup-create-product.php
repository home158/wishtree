...
<div class="pand-console">
    <div class="pane-header">
        <h1 id="myHeader" class="trend-header">{products_create}</h1>
    </div>

    <form enctype="multipart/form-data" id="signup-form" action="/admin/products/create" method="post">
        <div class="container block blk-reg">
            <div class="inside">
                ...
                <input name="product_title" id="product_title" type="text" value="<?php echo set_value('product_title'); ?>" /><br>
                &nbsp;<?php echo form_error('product_title'); ?><br>


                <span class="item">{product_cover_image} : </span>
                <div class="product_cover_image" style="background-image:url(<?php echo set_value('product_cover_image',''); ?>);background-position:<?php echo set_value('product_cover_image_position','0px 0px'); ?>;)">
                    {product_thumb} 
                </div><br>
                ...
                <input id='product_cover_image' name="product_cover_image" type="hidden" value="<?php echo set_value('product_cover_image'); ?>" />
                <input id='product_cover_image_thumb' name="product_cover_image_thumb" type="hidden" value="<?php echo set_value('product_cover_image_thumb'); ?>" />
                <input id='product_cover_image_position' name="product_cover_image_position" type="hidden" value="<?php echo set_value('product_cover_image_position'); ?>" />
                &nbsp;<?php echo form_error('product_cover_image'); ?><br>

                
                <span class="item">{product_sub_image} 1: </span>
                <div class="product_sub_image_0" style="background-image:url(<?php echo set_value('product_sub_image_0',''); ?>);background-position:<?php echo set_value('product_sub_image_0_position','0px 0px'); ?>;)">
                    {product_thumb} 
                </div><br>
                ...
                <input id='product_sub_image_0' name="product_sub_image_0" type="hidden" value="<?php echo set_value('product_sub_image_0'); ?>" />
                <input id='product_sub_image_0_thumb' name="product_sub_image_0_thumb" type="hidden" value="<?php echo set_value('product_sub_image_0_thumb'); ?>" />
                <input id='product_sub_image_0_position' name="product_sub_image_0_position" type="hidden" value="<?php echo set_value('product_sub_image_0_position'); ?>" />
                &nbsp;<?php echo form_error('product_sub_image_0'); ?><br>
                

                <span class="item">{product_sub_image} 2: </span>
                <div class="product_sub_image_1" style="background-image:url(<?php echo set_value('product_sub_image_1',''); ?>);background-position:<?php echo set_value('product_sub_image_1_position','0px 0px'); ?>;)">
                    {product_thumb} 
                </div><br>
                ...
                <input id='product_sub_image_1' name="product_sub_image_1" type="hidden" value="<?php echo set_value('product_sub_image_1'); ?>" />
                <input id='product_sub_image_1_thumb' name="product_sub_image_1_thumb" type="hidden" value="<?php echo set_value('product_sub_image_1_thumb'); ?>" />
                <input id='product_sub_image_1_position' name="product_sub_image_1_position" type="hidden" value="<?php echo set_value('product_sub_image_1_position'); ?>" />
                &nbsp;<?php echo form_error('product_sub_image_1'); ?><br>


                <span class="item">{product_sub_image} 3: </span>
                <div class="product_sub_image_2" style="background-image:url(<?php echo set_value('product_sub_image_2',''); ?>);background-position:<?php echo set_value('product_sub_image_2_position','0px 0px'); ?>;)">
                    {product_thumb} 
                </div><br>
                ...
                <input id='product_sub_image_2' name="product_sub_image_2" type="hidden" value="<?php echo set_value('product_sub_image_2'); ?>" />
                <input id='product_sub_image_2_thumb' name="product_sub_image_2_thumb" type="hidden" value="<?php echo set_value('product_sub_image_2_thumb'); ?>" />
                <input id='product_sub_image_2_position' name="product_sub_image_2_position" type="hidden" value="<?php echo set_value('product_sub_image_2_position'); ?>" />
                ...
                <textarea name="product_recipe" id="product_recipe" style="display:none;" >
                    <?php echo set_value('product_recipe'); ?>
                </textarea>
                ...
                <textarea name="product_order_note" id="product_order_note" style="display:none;" >
                    <?php echo set_value('product_order_note'); ?>
                </textarea>
                
                <span class="item">{gird_column_PriceMSRP} : </span>
                <input name="product_price_MSRP" id="product_price_MSRP" type="text" value="<?php echo set_value('product_price_MSRP'); ?>" /><br>
                <?php echo form_error('product_price_MSRP'); ?><br>

                <span class="item">{gird_column_PriceSpecial} : </span>
                <input name="product_price_special" id="product_price_special" type="text" value="<?php echo set_value('product_price_special'); ?>" /><br>
                <?php echo form_error('product_price_special'); ?><br>

                <span class="item">{gird_column_Stock} : </span>
                <input name="product_stock" id="product_stock" type="text" value="<?php echo set_value('product_stock'); ?>" /><br>    
                <?php echo form_error('product_stock'); ?><br>

                <span class="item">{gird_column_Soldout} : </span>
                <input name="product_soldout" id="product_soldout" type="text" value="0" /><br>    
                ...
                <input style="width: 10em;" name="product_off_shelf_time_date" id="product_off_shelf_time_date" type="text" value="<?php echo set_value('product_off_shelf_time_date'); ?>" readonly/>
                ...
                <div id="species_display_area" class="sub_section_area">
                    ...
                    <br>&nbsp;
                    <select name="product_species_category_r2" id="product_species_category_r2" >
                    ...
                    <input name="product_species_title" id="product_species_title" type="text" value="<?php echo set_value('product_species_title'); ?>" /><br>
                    &nbsp;&nbsp;<?php echo form_error('product_species_title'); ?><br>

                    &nbsp;<span class="item">{product_species_image} : </span>
                    <div class="product_species_image" style="background-image:url(<?php echo set_value('product_species_image',''); ?>);background-position:<?php echo set_value('product_species_image_position','0px 0px'); ?>;)">
                        {product_thumb} 
                    </div><br>
                    ...
                    <input id='product_species_image' name="product_species_image" type="hidden" value="<?php echo set_value('product_species_image'); ?>" />
                    <input id='product_species_image_thumb' name="product_species_image_thumb" type="hidden" value="<?php echo set_value('product_species_image_thumb'); ?>" />
                    <input id='product_species_image_position' name="product_species_image_position" type="hidden" value="<?php echo set_value('product_species_image_position'); ?>" />
                    ...
                    <textarea name="product_species_content" id="product_species_content" style="display:none;" >
                        <?php echo set_value('product_species_content'); ?>
                    </textarea>
                </div>
        </div>
    </div>
...
<script>
    ...
    $(function () {
        if( $('#species_display').attr('checked')) {            $('#species_display_area').show();
        }else{            $('#species_display_area').hide();
        }        if( $('#product_species_category_r1').val() == '1' ){
            $('#product_species_category_r2').show();
        }else{
        ...
        if( '<?php echo set_value('product_cover_image_thumb'); ?>' != ''){
            $('div.product_cover_image').html("&nbsp;").css({                //'background-image':'url(<?php echo set_value('product_cover_image'); ?>)',                //'background-position':'<?php echo set_value('product_cover_image_position'); ?>'            }).backgroundDraggable({                done:function(e){                    $('#product_cover_image_position').val($(e).css('backgroundPosition'));                }            });
        }
        if( '<?php echo set_value('product_sub_image_0_thumb'); ?>' != ''){
            $('div.product_sub_image_0').html("&nbsp;").css({                //'background-image':'url(<?php echo set_value('product_sub_image_0'); ?>)',                //'background-position':'<?php echo set_value('product_sub_image_0_position'); ?>'            }).backgroundDraggable({                done:function(e){                    $('#product_sub_image_0_position').val($(e).css('backgroundPosition'));                }            });
        }
        if( '<?php echo set_value('product_sub_image_1_thumb'); ?>' != ''){
            $('div.product_sub_image_1').html("&nbsp;").css({                //'background-image':'url(<?php echo set_value('product_sub_image_1'); ?>)',                //'background-position':'<?php echo set_value('product_sub_image_1_position'); ?>'            }).backgroundDraggable({                done:function(e){                    $('#product_sub_image_0_position').val($(e).css('backgroundPosition'));                }            });
        }
        if( '<?php echo set_value('product_sub_image_2_thumb'); ?>' != ''){
            $('div.product_sub_image_2').html("&nbsp;").css({                //'background-image':'url(<?php echo set_value('product_sub_image_2'); ?>)',                //'background-position':'<?php echo set_value('product_sub_image_2_position'); ?>'            }).backgroundDraggable({                done:function(e){                    $('#product_sub_image_2_position').val($(e).css('backgroundPosition'));                }            });
        }
        if( '<?php echo set_value('product_species_image'); ?>' != ''){
            $('div.product_species_image').html("&nbsp;").css({                //'background-image':'url(<?php echo set_value('product_species_image'); ?>)',                //'background-position':'<?php echo set_value('product_species_image_position'); ?>'            }).backgroundDraggable({                done:function(e){                    $('#product_species_image_position').val($(e).css('backgroundPosition'));                }            });
        }
        ...
        var CURRENT_CATEGORY = '<?php echo set_value('products_category'); ?>';
        if( typeof(window.opener.O_PARENT.tree) != 'undefined' && CURRENT_CATEGORY == ''){
            CURRENT_CATEGORY = window.opener.O_PARENT.tree.CURRENT_GUID;
        }
    /*
        if( 1 == <?= set_value('species_display' , 0); ?> ){
            $('#species_display').attr('checked' , true);
            $('#species_display_area').show();
        }else{
            $('#species_display').attr('checked' , false);
            $('#species_display_area').hide();
        }
      */  
        $("select[name=products_category] option")
