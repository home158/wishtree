...
<div class="pand-console">
    <div class="pane-header">
        <h1 id="myHeader" class="trend-header">{members_edit}</h1>
    </div>
        ...
        <div class="container block blk-reg">
            <div class="inside">
                ...
                <select name="rank" id="Rank">
                    <option value="1" <?php echo set_select('rank', '1', TRUE); ?>>{rank_normal_but_not_confirm}</option>
                    <option value="2" <?php echo set_select('rank', '1', TRUE); ?>>{rank_normal_confirmed}</option>
