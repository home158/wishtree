...
<div class="container market">
    <div class="banner-label banner-label-member">
        <img src="/_images/banner-label-history-center.png"/>
    </div>
    <div class="content block">
        <div class="inside" style="text-align: center;">
            <div class="welcome_msg">
                {orders_query_detail_welcome_msg}
            </div>
                ...
                <table class="order_history"  border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="/order/history_detail/{OrderGUID}" class="button_query">{button_query}</a></td>
                        </tr>
                        {/order_data}
                    </thead>
                </table>
            ...
            <div>
                <img src="/_images/banner-history.png" />
            </div>
        </div>
    </div>
    <div class="footer">
