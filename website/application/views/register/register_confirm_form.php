    ...
    <div class="content block blk-reg">
        <div class="inside">
            <div id="signup-form">
                ...
                <input name="email" id="Member_email" type="text" value="<?= set_value('email'); ?>"  />
                      
                <br><br>
                      
                <span class="item">{gird_column_Name} : </span>
                <input name="name" id="Member_name" type="text" value="<?= set_value('name'); ?>" />      
                ...
                <br>
                <em class="note">{member_city_must_select}</em><br>
                <?php echo form_error('city'); ?>
                <br>
                <br>    
                <input name="id" id="Member_id" type="hidden" value="<?= set_value('id'); ?>"/>
                <input name="register_type" id="Member_register_type" type="hidden" value="<?= set_value('register_type'); ?>"/>
                    
               <input  type="submit" id="submit_register" class="btn-calm-m" value="完成註冊"><br><br>
              * 註冊後即代表接受「小善心農業」<a href="/site/terms">服務條款</a> 及 <a href="/site/privacy">隱私權政策</a>，<br>
              同意使用「小善心農業」所提供的相關服務。
        </form>
           </div>
        </div>
