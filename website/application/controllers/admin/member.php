...
class Member extends Admin_Base_Controller {
    private $UI_columns = array('UserID','Nickname','GUID','ProfileReviewStatus');
    public function __construct()
    {
        parent::__construct();
        $this->parse_display_data(
            array( 'account' , 'rank' , 'email' , 'role' ,'btn', 'grid','register','member','city','language','birthday','height','bodytype','race',
                'income','property','education','maritalstatus' ,'smoking','drinking' , 'timezoneoffset' , 'dst' , 'alert' , 'menu' , 'contextmenu')
        );
    ...
    public function view($GUID = "00000000-0000-0000-0000-000000000000")
    {
        ...
        $this->display_data['member_total_rows'] = sprintf($this->display_data['member_total_rows'] , $data['num_rows'] );
